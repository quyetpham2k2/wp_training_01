...
!(function (a, b) {
    ...
    j
      ...
      : ((b = a('<div id="iris-gradtest" />')),
        ...
        a.each(l, function (a, e) {
          return (
            b.css(d, e + c), b.css(d).match("gradient") ? ((k = a), !1) : void 0
          );
        }),
        k === !1 &&
          (b.css(
  ...
  return (
    ...
    (l = ["-moz-", "-webkit-", "-o-", "-ms-"]),
    j && 7 >= q
      ? ((a.fn.iris = a.noop), (a.support.iris = !1), void 0)
      : ((a.support.iris = !0),
        ...
        (n = {
          ...
          _create: function () {
            ...
            k === !1 && c(),
              d.is("input")
                ? ((b.picker = b.options.target
                    ? a(i).appendTo(b.options.target)
                    : a(i).insertAfter(d)),
              ...
              p
                ? 9 === q
                  ...
                  : 8 >= q && b.picker.addClass("iris-ie-lt9")
              ...
              b.options.border && b.picker.addClass("iris-border"),
              b._initControls(),
              (b.active = "external"),
              b._dimensions(),
              b._change();
          ...
          _paletteListeners: function () {
            ...
            b.picker
              ...
              .on("keydown.palette", ".iris-palette", function (b) {
                return 13 !== b.keyCode && 32 !== b.keyCode
                  ? !0
                  : (b.stopPropagation(), a(this).click(), void 0);
              });
          },
          ...
          _isNonHueControl: function (a, b) {
            return "square" === a && "h" === this.options.controls.strip
              ? !0
  ...
  (function (a, b) {
    ...
    c.fn = c.prototype = {
      ...
      toLuminosity: function () {
        var a = this.toRgb();
        return (
          0.2126 * Math.pow(a.r / 255, 2.2) +
          0.7152 * Math.pow(a.g / 255, 2.2) +
          0.0722 * Math.pow(a.b / 255, 2.2)
        );
      },
      ...
      getReadableContrastingColor: function (a, d) {
        ...
        for (
          ...
          e > f &&
          (this.l(i, !0),
          (f = this.getDistanceLuminosityFrom(a)),
