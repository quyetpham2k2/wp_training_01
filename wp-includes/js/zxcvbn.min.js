...
(function () {
  ...
  ja = function (b) {
    ...
    c = g = e = 0;
    for (h = Math.min(a, b); 0 <= h ? g <= h : g >= h; c = 0 <= h ? ++g : --g)
      e += t(a + b, c);
    return n(e);
  };
  ia = function (b) {
  ...
  "undefined" !== typeof window && null !== window
    ? ((window.zxcvbn = o),
      "function" === typeof window.zxcvbn_load_hook &&
