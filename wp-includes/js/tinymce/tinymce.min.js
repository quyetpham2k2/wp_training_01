  ...
  r(l, [], function () {
      ...
      (x = e.support = {}),
        ...
        (e.matchesSelector = function (t, n) {
          if (
            ...
            (n = n.replace(ue, "='$1']")),
            !(!x.matchesSelector || !M || (P && P.test(n)) || (H && H.test(n))))
          )
            try {
              var r = O.call(t, n);
              if (
      ...
      return (
        ...
        (S = e.select =
          function (e, t, n, r) {
            ...
            return (
              (c || k(e, d))(r, t, !M, n, (ye.test(e) && u(t.parentNode)) || t),
              n
            );
          }),
      ...
      return function (a) {
        ...
        function p(e, t) {
          e &&
            ("string" != typeof e
              ...
              : ((t = t.length ? t : [t]),
                ae(t, function (e) {
                  e.deep === te && (e.deep = !e.selector),
                    e.split === te && (e.split = !e.selector || e.inline),
                    e.remove === te &&
                      e.selector &&
                      !e.inline &&
                      (e.remove = "none"),
        ...
        function v(t, n, r) {
              ...
              ae(a, function (e) {
                ...
                if (d.inline || d.wrapper) {
                  if (
                    (d.exact || 1 !== s || (e = o(e)),
                    ae(u, function (t) {
                      ae(U.select(t.inline, e), function (e) {
                  ...
                  d.merge_with_parents &&
                    U.getParent(e.parentNode, function (r) {
                      return C(r, t, n) ? (U.remove(e, 1), (e = 0), Z) : void 0;
                    }),
                    e &&
                      d.merge_siblings !== !1 &&
                      ((e = I(O(e), e)), (e = I(e, O(e, Z))));
                }
              });
          }
          var u = f(t),
          ...
          if (d)
            if (r)
              ...
              m &&
              d.inline &&
              !U.select("td.mce-item-selected,th.mce-item-selected").length
            )
              z("apply", t, n);
            else {
        ...
        function y(e, t, n, r) {
          ...
          function o(n) {
            var i;
            return (
              ae(l(n.parentNode).reverse(), function (n) {
                var o;
                i ||
                  "_start" == n.id ||
                  "_end" == n.id ||
                  ((o = C(n, e, t, r)), o && o.split !== !1 && (i = n));
              }),
              i
            );
          }
          ...
          function u(e) {
            ...
            return (
              oe(n) && (n = n[e ? "firstChild" : "lastChild"]),
              3 == n.nodeType &&
                0 === n.data.length &&
                (n = e
            ...
            : void ($.isCollapsed() &&
              ...
              !U.select("td.mce-item-selected,th.mce-item-selected").length
                ...
                : ((g = $.getBookmark()),
                  d($.getRng(Z)),
                  $.moveToBookmark(g),
                  h.inline && x(e, t, $.getStart()) && W($.getRng(!0)),
                  a.nodeChanged()));
        }
        function b(e, t, n) {
          var r = f(e);
          !x(e, t, n) || ("toggle" in r[0] && !r[0].toggle)
            ? v(e, t, n)
            : y(e, t, n);
        }
        function C(e, t, n, r) {
              ...
              if (s.length === te) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = "attributes" === i ? U.getAttrib(e, o) : T(e, o)),
                      r && !a && !t.exact)
                    )
                      return;
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (
                ((a = o[s]),
                k(e, a) && i(e, a, "attributes") && i(e, a, "styles"))
              ) {
                if ((l = a.classes))
        ...
        function k(e, t) {
          return S(e, t.inline)
            ...
            ? Z
            : t.selector
            ? 1 == e.nodeType && U.is(e, t.selector)
            : void 0;
        }
        function S(e, t) {
          return (
        ...
        function R(e, t) {
          return (
            ("color" == t || "backgroundColor" == t) && (e = U.toHex(e)),
        ...
        function L(t, n, r) {
          function i(e) {
            ...
            if (
              ...
              (s = U.getRoot()),
              3 == r.nodeType && !B(r) && (e ? v > 0 : b < r.nodeValue.length))
            )
              return r;
            for (;;) {
              if (!n[0].block_expand && Y(i)) return i;
              for (o = i[a]; o; o = o[a])
                if (!oe(o) && !B(o) && !t(o)) return i;
              if (i.parentNode == s) {
                r = i;
                break;
              }
          ...
          function u(t, n, i) {
            ...
            for (
              s = new e(t, U.getParent(t, Y) || a.getBody());
              (l = s[i ? "prev" : "next"]());
          ...
          function f(e, t) {
            var r,
              i = U.getRoot();
            if (
              (n[0].wrapper || (r = U.getParent(e, n[0].block, i)),
              r ||
                (r = U.getParent(
          ...
          if (
            ...
            (g = c(g)),
            (y = c(y)),
            (oe(g.parentNode) || oe(g)) &&
              ((g = oe(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (oe(y.parentNode) || oe(y)) &&
              ((y = oe(y) ? y : y.parentNode),
        ...
        function H(e, t, n, r) {
          ...
          if ("all" != e.remove)
            for (
              ae(e.styles, function (i, o) {
                (i = R(A(i, t), o)),
                  "number" == typeof o && ((o = i), (r = 0)),
                  (e.remove_similar || !r || S(T(r, o), i)) &&
                    U.setStyle(n, o, ""),
                  (a = 1);
              }),
                a &&
                ...
                ae(e.attributes, function (e, i) {
                  var o;
                  if (
                    ((e = A(e, t)),
                    "number" == typeof i && ((i = e), (r = 0)),
                    !r || S(U.getAttrib(r, i), e))
                  ) {
                    if (
                      "class" == i &&
                      ((e = U.getAttrib(n, i)),
                    ...
                    "class" == i && n.removeAttribute("className"),
                      J.test(i) && n.removeAttribute("data-mce-" + i),
                      n.removeAttribute(i);
                  }
                }),
        ...
        function P(e, t) {
          ...
          t.block &&
            (K
              ? r == U.getRoot() &&
                ((t.list_block && S(e, t.list_block)) ||
                  ae(se(e.childNodes), function (e) {
                    j(K, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = D(e, K)),
                          U.setAttribs(i, a.settings.forced_root_block_attrs))
                      : (i = 0);
                  }))
              : Y(e) &&
                !Y(r) &&
                (n(e, Q) ||
                  n(e.firstChild, Z, 1) ||
                  e.insertBefore(U.create("br"), e.firstChild),
                n(e, Z) ||
                  n(e.lastChild, Q, 1) ||
                  e.appendChild(U.create("br")))),
            (t.selector && t.inline && !S(t.inline, e)) || U.remove(e, 1);
        }
        function O(e, t, n) {
          if (e)
            for (
                ...
                le(
                  ...
                  function (e) {
                    1 != e.nodeType ||
                      e.id === g ||
                      U.isEmpty(e) ||
                      U.setAttrib(e, "data-mce-bogus", null);
                  },
                  "childNodes"
                );
          }
        ...
        function W(t) {
          ...
          if (
            (3 == n.nodeType &&
              r >= n.nodeValue.length &&
              ((r = G(n)), (n = n.parentNode), (i = !0)),
            1 == n.nodeType)
          )
            for (
              s = n.childNodes,
                n = s[Math.min(r, s.length - 1)],
                o = new e(n, U.getParent(n, U.isBlock)),
              ...
              if (3 == a.nodeType && !B(a))
                return (
                  (l = U.create("a", { "data-mce-bogus": "all" }, X)),
    ...
    r(I, [B, u, d, N], function (e, t, n, r) {
      ...
      return (
        ...
        function (n) {
          function a() {
            var e = n.getContent({ format: "raw", no_events: 1 }),
              ...
              d = n.schema;
            for (
              e = e.replace(o, ""), u = d.getShortEndedElements();
              (c = t.exec(e));
          ...
          return (
            ...
            n.on("KeyUp", function (e) {
              ...
              ((r >= 33 && 36 >= r) ||
                ...
                e.ctrlKey) &&
                (s(), n.nodeChanged()),
                (46 == r || 8 == r || (t.mac && (91 == r || 93 == r))) &&
                  n.nodeChanged(),
                f &&
                  l.typing &&
                  (n.isDirty() ||
                    ((n.isNotDirty = !u[0] || a() == u[0].content),
                    n.isNotDirty ||
                      n.fire("change", { level: u[0], lastLevel: null })),
                  n.fire("TypingUndo"),
                  (f = !1),
                  n.nodeChanged());
            }),
            n.on("KeyDown", function (t) {
              var n = t.keyCode;
              if ((n >= 33 && 36 >= n) || (n >= 37 && 40 >= n) || 45 == n)
                return void (l.typing && s(t));
              ...
              !(16 > n || n > 20) ||
                ...
                l.typing ||
                r ||
                (l.beforeChange(), (l.typing = !0), l.add({}, t), (f = !0));
            }),
            n.on("MouseDown", function (e) {
              l.typing && s(e);
            }),
            n.addShortcut("meta+z", "", "Undo"),
            n.addShortcut("meta+y,meta+shift+z", "", "Redo"),
            ...
            (l = {
              ...
              add: function (e, t) {
                var r,
                  i = n.settings,
                  o;
                if (((e = e || {}), (e.content = a()), p || n.removed))
                  return null;
                if (
                  ((o = u[c]),
                  n
                ...
                if (
                  ...
                  i.custom_undo_redo_levels &&
                    u.length > i.custom_undo_redo_levels)
                ) {
              ...
              undo: function () {
                ...
                return (
                  ...
                  c > 0 &&
                    ((e = u[--c]),
                    0 === c && (n.isNotDirty = !0),
                    n.setContent(e.content, { format: "raw" }),
                    n.selection.moveToBookmark(e.beforeBookmark),
                    n.fire("undo", { level: e })),
                  e
                );
              },
              redo: function () {
                ...
                return (
                  c < u.length - 1 &&
                    ((e = u[++c]),
                    n.setContent(e.content, { format: "raw" }),
                    n.selection.moveToBookmark(e.bookmark),
                    n.fire("redo", { level: e })),
                  e
                );
              },
            ...
            /^(OL|UL|LI)$/.test(n) && (F = "LI"),
              ...
              e(!0) && e()
                ...
                : ((P = t()),
                  ...
                  S.setEndAfter(P),
                  (H = S.extractContents()),
                  "LI" == F && "LI" == H.firstChild.nodeName
                    ? ((M = H.firstChild), a.insertAfter(H, P))
                    : (a.insertAfter(H, P), a.insertAfter(M, P))),
              a.remove(B),
              g(M),
              c.add();
          }
              ...
              (F && B === i.getBody()) ||
                ...
                b()
                  ? ((M =
                    ...
                    g(M))
                  : b(!0)
                  ? ((M = B.parentNode.insertBefore(y(), B)), h(M), g(B))
                  : ((S = k.cloneRange()),
                    S.setEndAfter(B),
                    (H = S.extractContents()),
                    _(H),
            ...
            function n(e) {
              ...
              if (t !== n) {
                if (
                  ...
                  for (
                    s = n.parents().toArray().reverse(), s.push(n), r = 0;
                    r < s.length && a[r] === s[r];
                    r++
                  );
    ...
    r(re, [ee, te, ne, Y], function (e, t, n, r) {
      function i() {
        function e(e, t) {
          for (; e; ) {
            if (e == t) return !0;
    ...
    r(ie, [re, ee, Y, Q], function (e, t, n, r) {
      var i = e.extend({
        modal: !0,
        Defaults: {
          border: 1,
    ...
    r(se, [B, x, h, _, g, u, d], function (e, t, n, r, i, o, a) {
      return function (s) {
          ...
          function l(e) {
            ...
            if (
              ...
              return (
                ...
                (i = o(n, !1)),
                (a = o(r, !0)),
                v.isEmpty(r) || K(n).append(r.childNodes),
                K(r).remove(),
                i
                  ? 1 == i.nodeType
                    ? "BR" == i.nodeName
                ...
                (n = s.selection.getRng()),
                  ...
                  r.length
                    ? ((i = v.createFragment()),
                      ...
                      v.isEmpty(o) ? K(o).empty().append(i) : n.insertNode(i),
        ...
        function D() {
          ...
          c() >= 10 &&
            ((e = ""),
            Y("p div h1 h2 h3 h4 h5 h6".split(" "), function (t, n) {
              e += (n > 0 ? "," : "") + t + ":empty";
            }),
          ...
          (N.prototype = {
            ...
            getContent: function (e) {
              ...
              return (
                ...
                "text" != e.format ? (e.content = L(n)) : (e.content = n),
    ...
    r(Me, [Ne, Q, Y, Le], function (e, t, n, r) {
      return e.extend({
            ...
            for (
              ...
              (p = r[t]),
                ...
                "center" === s
                  ...
                  : "stretch" === s
                  ? ((x[M] = z(h[H] || 0, i[L] - o[P] - o[O])), (x[D] = o[P]))
                  : "end" === s && (x[D] = i[L] - h[M] - o.top),
                h.flex > 0 && (y += h.flex * C),
                (x[E] = y),
                (x[k] = w),
                p.layoutRect(x),
    ...
    r($e, [K, Ne, re, d, he, u], function (e, t, n, r, i, o) {
      function a(e) {
        function t(t, n) {
          return function () {
            var r = this;
